...
public:
	...
	void PrepareScene();
	//render the objects and textures in the 3d scene
	void RenderScene();
	//Load needed textures before rendition
	void LoadSceneTextures();
	//define all 3d object materials for rendering
	void DefineObjectMaterials();
	//include and define all light sources for rendering
